...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>conscrypt</b> with <b>org.conscrypt:conscrypt-android</b> coordinates and
    ...
    /**
     * Dependency provider for <b>popcornview</b> with <b>com.github.gold24park:PopcornView</b> coordinates and
     * with version reference <b>popcornview</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getPopcornview() {
        return create("popcornview");
    }
    ...
    public static class AndroidxMedia3CommonLibraryAccessors extends SubDependencyFactory {
         ...
         * with version <b>1.5.0-alpha01</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        private final FirebaseDynamicLibraryAccessors laccForFirebaseDynamicLibraryAccessors = new FirebaseDynamicLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>firebase.dynamic</b>
         */
        public FirebaseDynamicLibraryAccessors getDynamic() {
            return laccForFirebaseDynamicLibraryAccessors;
        }
    ...
    public static class FirebaseDynamicLibraryAccessors extends SubDependencyFactory {
        private final FirebaseDynamicLinksLibraryAccessors laccForFirebaseDynamicLinksLibraryAccessors = new FirebaseDynamicLinksLibraryAccessors(owner);

        public FirebaseDynamicLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>firebase.dynamic.links</b>
         */
        public FirebaseDynamicLinksLibraryAccessors getLinks() {
            return laccForFirebaseDynamicLinksLibraryAccessors;
        }

    }

    public static class FirebaseDynamicLinksLibraryAccessors extends SubDependencyFactory {

        public FirebaseDynamicLinksLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>com.google.firebase:firebase-dynamic-links-ktx</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("firebase.dynamic.links.ktx");
        }
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>retrofit.rxjava</b>
         */
        public RetrofitRxjavaLibraryAccessors getRxjava() {
            return laccForRetrofitRxjavaLibraryAccessors;
        }
    ...
    public static class RetrofitConverterLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit.converter.scalars</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitRxjavaLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>adapter</b> with <b>com.squareup.retrofit2:adapter-rxjava2</b> coordinates and
         * with version reference <b>retrofit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAdapter() {
            return create("retrofit.rxjava.adapter");
        }

    }

    public static class RxbindingLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public RxbindingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>rxbinding</b> with <b>com.jakewharton.rxbinding3:rxbinding</b> coordinates and
        ...
        /**
         * Dependency provider for <b>drawerlayout</b> with <b>com.jakewharton.rxbinding3:rxbinding-drawerlayout</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDrawerlayout() {
            return create("rxbinding.drawerlayout");
        }

        /**
         * Dependency provider for <b>material</b> with <b>com.jakewharton.rxbinding3:rxbinding-material</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMaterial() {
            return create("rxbinding.material");
        }

        /**
         * Dependency provider for <b>swiperefreshlayout</b> with <b>com.jakewharton.rxbinding3:rxbinding-swiperefreshlayout</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>conscrypt</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>daggerCompiler</b> with value <b>2.50</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>otpview</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>popcornview</b> with value <b>release-1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPopcornview() { return getVersion("popcornview"); }
        ...
        /**
         * Version alias <b>rxbinding</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxjava</b> with value <b>2.2.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>timber</b> with value <b>5.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>xxpermissions</b> with value <b>16.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OkhttpVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>okhttp.logging</b> with value <b>4.9.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RetrofitConverterVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>retrofit.converter.scalars</b> with value <b>2.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getScalars() { return getVersion("retrofit.converter.scalars"); }
